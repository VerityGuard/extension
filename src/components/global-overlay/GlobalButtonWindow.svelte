...
{#if open}
    <div class="global-window-wrapper" transition:fly={{y: 10, duration: 200}}>
        <div class="global-window-header">
            <div class="global-window-header-icon" style="background-image: url({icon});">&nbsp;</div>
            <div class="global-window-header-tabs">
                <button class="global-window-header-tab global-window-header-settings" on:click={onSettingsClick}>
                ...
                <button class="global-window-header-tab global-window-header-close" on:click={onCloseClick}>
        ...
        <div class="global-window-content">
            <LoaderRing />
        </div>
    </div>
{/if}
...
<style>
    ...
    .global-window-header-tabs {
        display: flex;
        align-items: center;
        margin-right: 4px;
    }
    .global-window-header-tab:active {
        background: #c6cbde;
    }
    .global-window-header-tab:hover {
        background-color: #e7e9f5;
    }
    .global-window-header-tab {
        display: flex;
        align-items: center;
